...
layout(set = 1, binding = 7) uniform sampler2D surfaceRenderedDistanceImage;
layout(set = 1, binding = 8) uniform sampler2D waterRenderedNormalMetalnessImage;
layout(set = 1, binding = 9) uniform sampler2D waterRenderedDistanceImage;
