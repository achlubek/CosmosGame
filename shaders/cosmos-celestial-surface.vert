...
void main() {
    ...
    float surfaceHeight = texture(heightMapImage, xyzToPolar(body.rotationMatrix * dir)).r;
    vec3 WorldPos = dir * (body.radius + body.terrainMaxLevel * surfaceHeight) + body.position;
