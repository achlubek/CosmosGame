...
namespace UnitTests
{
    ...
    public:
        ...
        TEST_METHOD(TestMethod1)
        {
            ...
            glm::dvec3 cosmosPositionSurface = bodypos + glm::dvec3(0.0, body.radius * 10.0, 0.0);
            glm::dvec3 cosmosPosition100KM = bodypos + glm::dvec3(0.0, body.radius * 10.0 + 100.0, 0.0);
            glm::dvec3 cosmosPosition1000KM = bodypos + glm::dvec3(0.0, body.radius * 10.0 + 1000.0, 0.0);
