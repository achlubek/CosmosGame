    ...
    : AbsGameStage(container)
{
    ...
    freeFlightButton = new UIText(ui, 0.01, 0.2, UIColor(1.0, 1.0, 1.0, 1.0), Media::getPath("chintzy.ttf"), 13, "Free flight");
    ui->addDrawable(freeFlightButton);

    editorButton = new UIText(ui, 0.01, 0.24, UIColor(1.0, 1.0, 1.0, 1.0), Media::getPath("chintzy.ttf"), 13, "Celestial bodies preview");
    ui->addDrawable(editorButton);

    quitButton = new UIText(ui, 0.01, 0.28, UIColor(1.0, 1.0, 1.0, 1.0), Media::getPath("chintzy.ttf"), 13, "Quit game");
